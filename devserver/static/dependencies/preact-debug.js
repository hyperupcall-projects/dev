import { options as l$1, Component as x, Fragment as k } from './preact.js'
	...
	(i$1 =
		'undefined' != typeof globalThis
			...
			: 'undefined' != typeof window
				? window
				: void 0) &&
	i$1.__PREACT_DEVTOOLS__ &&
	i$1.__PREACT_DEVTOOLS__.attachPreact('10.26.2', l$1, { Fragment: k, Component: x })
				...
				if ('function' == typeof e.type && e.type.propTypes) {
					if ('Lazy' === e.type.displayName && E && !E.lazyPropTypes.has(e.type)) {
						...
						try {
							...
							console.warn(
								s + "We will log the wrapped component's name once it is loaded.",
							)
						}
					}
					var l = e.props
