	...
	return [
		{
			...
			groupId: 'personal',
			repos: matchAndTake([
				'hyperupcall-incubating/sauerkraut',
				'hyperupcall-incubating/event-horizon',
				'hyperupcall-incubating/antarctica',
				'hyperupcall-incubating/font-finder',
				'hyperupcall-incubating/apfelstrudel',
				'hyperupcall-incubating/link-tracker',
				'hyperupcall-projects/pick-sticker',
			]),
		},
		{
			groupName: 'JSON Schema',
			groupId: 'json-schema',
			repos: matchAndTake(['SchemaStore/*', 'hyperupcall-projects/jsonschema-extractor'], {
		...
		{
			groupName: 'Hyperupcall Configuration',
			groupId: 'configuration-repos',
			repos: matchAndTake([
				'hyperupcall-projects/*prettier*',
				'hyperupcall-projects/*eslint*',
				'hyperupcall-projects/*stylelint*',
				'hyperupcall-projects/*lefthook*',
				'hyperupcall-projects/*markdownlint*',
				'hyperupcall-projects/hyperupcall-scripts-*',
				'hyperupcall-projects/hyperupcall-config-utils',
			]),
		},
		{
			groupName: 'VSCode Extensions',
			groupId: 'vscode-extensions',
			repos: matchAndTake(['hyperupcall-projects/vscode-*', 'hyperupcall-projects/vscode-*']),
		},
		{
			groupName: 'Other',
			groupId: 'other',
